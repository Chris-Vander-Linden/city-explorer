...
import { MdFastfood, MdLocalMovies, MdOutlineMap } from "react-icons/md";
  ...
  render() {
    return <nav>
      <ul>
        ...
        <li onClick={ this.props.onHandleNavClick } data-name="movieShow" data-value={ this.props.movieShow } className={ this.props.movieShow ? "active" : "" }><MdLocalMovies /></li>
